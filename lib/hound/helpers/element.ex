defmodule Hound.Helpers.Element do
  ...
  @doc """
  Takes screenshot of the current element. The screenshot is saved in the current working directory.
  ...
  def take_screenshot(element, path \\ nil) do
    element_id = get_element_id(element)
    session_id = Hound.current_session_id
    base64_png_data = make_req(:get, "session/#{session_id}/element/#{element_id}/screenshot")
